ft_chisq_selector <- function (x, features.col = "features", label.col = "label", output.col = "selected_features", num.top.features = 50, ...) {
...
environment(ft_chisq_selector) <- asNamespace('sparklyr')